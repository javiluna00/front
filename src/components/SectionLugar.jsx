...
function SectionLugar({ data }) {
  ...
  return (
    <div className="md:h-screen bg-gradient-to-br from-amber-100 via-amber-100 to-amber-950 w-full flex justify-center py-20">
      ...
      <div className="container">
        <div className="flex md:flex-row flex-col items-center justify-center md:h-full gap-10">
          <div className="w-full flex flex-col justify-start items-start gap-10 px-10">
            ...
            <button className="border-2 border-amber-500 text-amber-500 bg-white hover:bg-amber-500 hover:text-black py-4 px-8 font-semibold w-full md:w-72 uppercase tracking-wider transition-all duration-200 text-sm flex items-center justify-center gap-2"><MapPinIcon size={24} />{boton || '¡Ven a visitarnos!'}</button>
          </div>
