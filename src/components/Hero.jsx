...
function Hero({ data }) {
  ...
  return (
    <section className={`relative flex md:h-screen h-screen py-36 items-center bg-no-repeat bg-top bg-cover w-full flex flex-col justify-center items-center`} style={{backgroundImage: `url(${backgroundImageUrl})`}}>
